...
import {
  ...
  Activity, Code2, Shield, AlertTriangle, ChevronRight
} from 'lucide-react';
...
export default function NewScan() {
  ...
  const { mutateAsync: createScan, isLoading } = useCreateScan();
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                          ...
                          className={`text-left px-4 py-3 rounded border transition-all duration-200 ${
                            active
                              ...
                              : 'border-[#1a1d26] bg-[#0d0d0f] text-gray-400 hover:border-[#1a1d26]/60 hover:bg-[#252830]/20'
                          }`}
                        >
          ...
          {selectedType && selectedInfo && (
            ...
            >
              ...
              <span className="text-gray-600">— {selectedInfo.desc}</span>
            </motion.div>
          )}
